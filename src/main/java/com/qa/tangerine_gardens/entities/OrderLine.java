/* Entity table for order line created by Christine Stokes. Other than an autogenerated
 * number the values in the columns require to be obtained through the order and product 
 * entities
 */
