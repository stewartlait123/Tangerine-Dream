...
public class Product{		
	...
	/** The quantity of the product that should be bought when stock reaches min_stock */
	public void setOrder_amount(int value) { this.order_amount = value; }
